...
namespace Core.Entities.Mar
{
    ...
    public class VsoftSupplierInvoice : BaseEntity
    {
        // COMMON        
        [StringLength(11)]
        public required string V033 { get; set; } // doc number V033
        [StringLength(12)]
        public required string A110 { get; set; } // 'L'+A110 in mdv database
        [StringLength(8)]
        ...
        public virtual required VsoftSupplier VsoftSupplier { get; set; }
    }
}

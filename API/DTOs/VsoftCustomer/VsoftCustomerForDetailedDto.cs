...
{
    public class VsoftCustomerForDetailedDto : BaseEntity
    {
        // MAIN
        ...
        public required ICollection<VsoftContractForDetailedDto> VsoftContracts { get; set; }
        public required ICollection<VsoftCustomerInvoiceForDetailedDto> VsoftCustomerInvoices { get; set; }
    }
}

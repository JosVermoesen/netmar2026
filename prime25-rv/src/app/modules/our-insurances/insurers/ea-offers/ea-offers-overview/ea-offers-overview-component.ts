...
@Component({
    selector: 'app-ea-offers-overview',
    templateUrl: './ea-offers-overview-component.html',
    standalone: true,
    changeDetection: ChangeDetectionStrategy.Eager,
    imports: [GalleriaModule, PrimeTemplate, DialogModule, FormsModule, ButtonDirective, Ripple, TranslateModule]
})
export class EaOffersOverviewComponent {
    dialogVisible = false;
    radioChoise = '';
    ...
    ngOnInit(): void {
        ...
        this.insurerService.getOffers('ea').then((result: IOffers[]) => {
            this.offers = result;

...
@Component({
    ...
    imports: [LedgerAccountItem, MatButton, MatIcon, MatMenu, MatSelectionList, MatListOption, MatMenuTrigger, MatPaginator, FormsModule, EmptyState],
...
export class LedgerAccounts implements OnInit {
    ...
    ledgerAccounts = signal<Pagination<LedgerAccount> | null>(null);
    sortOptions = [
    ...
    getLedgerAccounts() {
        this.ledgerAccountService.getLedgerAccounts(this.ledgerAccountParams).subscribe({

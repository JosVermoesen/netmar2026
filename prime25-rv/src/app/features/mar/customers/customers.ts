...
@Component({
    ...
    imports: [CustomerItem, MatButton, MatIcon, MatMenu, MatSelectionList, MatListOption, MatMenuTrigger, MatPaginator, FormsModule, EmptyState],
...
export class Customers implements OnInit {
    ...
    customers = signal<Pagination<Customer> | null>(null);
    sortOptions = [

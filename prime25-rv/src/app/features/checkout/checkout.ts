...
@Component({
    ...
    imports: [OrderSummary, MatStepperModule, MatButton, MatCheckboxModule, RouterLink, CheckoutDeliveryComponent, CheckoutReview, CurrencyPipe, MatProgressSpinnerModule],
        ...
        try {
            ...
            if (confirmationToken) {
                ...
                if (result.error) {
                    ...
                    this.router.navigateByUrl('/features/checkout/success');
                }
            }
        } catch (error: any) {

...
@Component({
    ...
    template: `
        <div id="home" class="grid grid-cols-12 gap-4 grid-nogutter justify-between items-center mb-12 py-12 md:mb-20 md:py-20">
            ...
            <div class="col-span-12 md:col-span-7 order-0 md:order-1 mb-12 md:mb-0 rounded-lg">
                <img animateEnter="moveinright" src="/demo/images/landing/{{ darkMode ? 'dashboard-dark' : 'dashboard-light' }}.png" alt="" class="w-full h-full rounded-lg shadow-sm animate-duration-1000 animate-fadeinright" />
            </div>
        </div>
    `
})
